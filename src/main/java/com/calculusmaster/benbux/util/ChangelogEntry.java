...
public class ChangelogEntry
{
    ...
    {
        return "***" + BenBux.VERSION + "***:\n" + Global.changelogs.stream().filter(cl -> cl.getVersion().equals(BenBux.VERSION.substring(0, 3))).collect(Collectors.toList()).get(0).getFullChangelog();
    }
}
